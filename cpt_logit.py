...
from support.acc_funs import auc
...
for ii, vv in enumerate(cn_Y):
    ...
    for yy in tmp_train_years:
        ...
        # here compare gridsearch results to logistic regression results from before.
    ...
    for yy in tmp_train_years:
        ...
        for cc in top_cpts:
            ...
            if all(np.unique(sub_ytrain.values) == 0) or all(np.unique(sub_ytest.values) == 0):
                ...
                # HERE - implement what you did above for submodels
